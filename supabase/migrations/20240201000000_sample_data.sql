-- =====================================================
-- SAMPLE DATA FOR ALL MODULES (10 RECORDS EACH)
-- =====================================================
...
((SELECT id FROM leads WHERE lead_number = 'LEAD-2024-010'), 'meeting', 'Contract Signing', 'Final meeting and contract execution', '2024-02-10', true);
